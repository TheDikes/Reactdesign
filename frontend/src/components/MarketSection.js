...
const MarketSection = () => {
 ...
 <div>
      ...
      <img className="group-child5" alt="" src="/rectangle-13.svg" />
      <b className="consulting">CONSULTING</b>
      <b className="advices">ADVICES</b>
      <div className="div3">88%</div>
      <div className="div4">68%</div>
      <img className="group-child6" alt="" src="/rectangle-14.svg" />
      <img
        className="icon-feather-phone-call"
        alt=""
        src="/icon-featherphonecall.svg"
      />
